...
def main():
    ...
    keys = [
        ...
        #     lazy.spawn("~/.config/polybar/forest/scripts/powermenu.sh"),
        #     desc='Open rofi session menu.'
        #     ),
        Key(["control", "shift"], "e",
    ...
    groups = [
        ...
        Group("9", layout=defaultLayout),
        Group("0", layout=defaultLayout)
    ]
    # for i in range(10):
    #     groups.append(Group(i, layout="monadtall"))
    # groups = [Group(i, layout=defaultLayout) for i in range(10)]
